...
pub const CAPTURE_WIDTH: i32 = 800;
pub const CAPTURE_HEIGHT: i32 = 600;
...
pub const OUTPUT_VIDEO: bool = true;
pub const OUTPUT_VIDEO_FILE: &str = "output.mp4";
pub const OUTPUT_FPS: f64 = 30f64;
